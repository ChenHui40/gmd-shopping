...
public interface UsersRepository extends JpaRepository<Users, Integer>,JpaSpecificationExecutor<Users> {
	 ...
	 */
	@Query("select new com.springcloud.entity.Users(u.userId,u.userName,userNumber,userPassword,userSex,userPhone,userSite,userBirthday,userEmail,userPhoto,jdictionId,userStatus)"
